...
/// <summary>
/// Builds compact GitHub repository watch momentum data for UI and report surfaces.
/// </summary>
internal static class GitHubObservabilitySummaryService {
    ...
    internal static GitHubObservabilitySummaryData CreateMissingDatabaseSummary(string dbPath) {
    ...
    internal static int CountDistinctForkOwners(
        IReadOnlyList<GitHubRepositoryForkSnapshotRecord>? snapshots,
        IReadOnlyCollection<string>? parentRepositories = null) {
        if (snapshots is null || snapshots.Count == 0) {
            return 0;
    ...
    internal static int CountDistinctStargazers(
        IReadOnlyList<GitHubRepositoryStargazerSnapshotRecord>? snapshots,
        IReadOnlyCollection<string>? repositories = null) {
    ...
    internal static IReadOnlyList<GitHubRepositoryForkSnapshotRecord> BuildLatestForkSnapshots(
        IReadOnlyList<GitHubRepositoryForkSnapshotRecord>? snapshots,
        IReadOnlyCollection<string>? repositories = null) {
        if (snapshots is null || snapshots.Count == 0) {
    ...
    internal static IReadOnlyList<GitHubObservedTrendPointData> BuildTrendPoints(IReadOnlyList<GitHubRepositorySnapshotDelta> dailyDeltas) {
    ...
    internal static int GetForkChangePriority(GitHubRepositoryForkChange change) {
        if (change is null) {
            return 0;
        }
