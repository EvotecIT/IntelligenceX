---
title: Web Setup UI
description: Local web UI for visual IntelligenceX configuration
collection: docs
layout: docs
nav.weight: 30
---
...
- OpenAI login is not wired into the web UI yet. Provide `authB64`/`authB64Path` or keep "Skip OpenAI secret" enabled.
- Update-secret requires a pre-exported auth bundle
- The UI supports multi-repo setup, repo inspection, and setup recommendations
