...
description: Codex app-server client, ChatGPT auth helpers, and AI integration for .NET
collection: docs
layout: docs
nav.weight: 10
---
...
See [Providers](/docs/library/providers/) for details on ChatGPT and Copilot support.
