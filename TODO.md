...
- [ ] PR #802: Required `website-build` check is infra-blocked by upstream `PSPublishModule` dependency vulnerability advisories (`Magick.NET-Q8-AnyCPU`) unrelated to reviewer/static diff; track until dependency upstream is remediated. Source: https://github.com/EvotecIT/IntelligenceX/actions/runs/22389993353/job/64809285695 (prior occurrence: https://github.com/EvotecIT/IntelligenceX/actions/runs/22389852633/job/64808802599)
