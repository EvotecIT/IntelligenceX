...
- [x] PR #802: `website-build` infra block was observed on earlier runs due upstream `PSPublishModule` `Magick.NET-Q8-AnyCPU` advisories, then cleared without code changes in this PR (pass run: https://github.com/EvotecIT/IntelligenceX/actions/runs/22390141643/job/64809792868; prior failing occurrences: https://github.com/EvotecIT/IntelligenceX/actions/runs/22389993353/job/64809285695 and https://github.com/EvotecIT/IntelligenceX/actions/runs/22389852633/job/64808802599).
