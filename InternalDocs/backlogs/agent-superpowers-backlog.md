...
- [x] (P1) Add AD service-account usage and dormant-account query wrappers (`ad_service_account_usage`, `ad_never_logged_in_accounts`) with safe limits and structured output.
