...
- [x] Replace any remaining lexical fallback routing gates with structure-first contracts where still present.
...
- [x] Add a plugin lifecycle contract test suite: manifest validation, load order, health probe contract, and failure-mode telemetry.
