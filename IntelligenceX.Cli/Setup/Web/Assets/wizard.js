...
function updateAnalysisControls() {
  ...
  if (hint) {
    hint.textContent = applicable
      ? 'Leave empty to use defaults. Examples: all-50, all-100, all-500, all-security-50, all-security-default, powershell-50, javascript-50, python-50. Browse packs: intelligencex analyze list-rules --workspace <repo-root> --format markdown. Gate semantics/docs: Docs/reviewer/static-analysis.md'
