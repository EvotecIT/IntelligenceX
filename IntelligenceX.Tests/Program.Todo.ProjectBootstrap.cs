...
""";
    ...
    private static void TestProjectBootstrapWorkflowTemplateEnablesApplyLabels() {
        ...
        AssertContainsText(rendered, "\"${EXTRA_ARGS[@]}\"", "workflow applies optional sync args via quoted array expansion");
        ...
        AssertContainsText(rendered, "\"${VIEW_ARGS[@]}\"", "workflow applies optional view args via quoted array expansion");
