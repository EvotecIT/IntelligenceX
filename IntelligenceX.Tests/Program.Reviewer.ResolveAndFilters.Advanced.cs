...
internal static partial class Program {
    ...
    private static void TestReviewFormatterCopilotModelUsageUsesProviderDisplay() {
        ...
        AssertContainsText(comment, "- Transport: `native-http`", "copilot model usage transport");
        AssertContainsText(comment, "- Model: `Copilot model required`", "copilot model usage default label");
