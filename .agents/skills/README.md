...
- `intelligencex-write-tool-authoring`: Use for adding/refactoring mutating tools with shared write-governance schema, auth probe contracts, responses, and tests.
