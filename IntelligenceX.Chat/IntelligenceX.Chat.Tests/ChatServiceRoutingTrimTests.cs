...
public sealed partial class ChatServiceRoutingTrimTests {
    ...
    private static readonly MethodInfo ApplyToolExposureOverridesMethod =
        typeof(ChatServiceSession).GetMethod("ApplyToolExposureOverrides", BindingFlags.NonPublic | BindingFlags.Static)
        ?? throw new InvalidOperationException("ApplyToolExposureOverrides not found.");
