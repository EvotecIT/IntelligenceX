...
The JSON report now includes `schema_version` (`chat-startup-profile-v2`) and a `simulation` block. Additive fields are backward-compatible for existing consumers.
