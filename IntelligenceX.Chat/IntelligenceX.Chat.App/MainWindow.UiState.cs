        ...
        var json = JsonSerializer.Serialize(new {
            ...
            policy = _sessionPolicy is null ? null : new {
                ...
                routingCatalog = _sessionPolicy.RoutingCatalog is null ? null : new {
                    ...
                    explicitRoutingTools = _sessionPolicy.RoutingCatalog.ExplicitRoutingTools,
                    inferredRoutingTools = _sessionPolicy.RoutingCatalog.InferredRoutingTools,
                    missingRoutingContractTools = _sessionPolicy.RoutingCatalog.MissingRoutingContractTools,
                    missingPackIdTools = _sessionPolicy.RoutingCatalog.MissingPackIdTools,
                    missingRoleTools = _sessionPolicy.RoutingCatalog.MissingRoleTools,
                    setupAwareTools = _sessionPolicy.RoutingCatalog.SetupAwareTools,
                    handoffAwareTools = _sessionPolicy.RoutingCatalog.HandoffAwareTools,
                    recoveryAwareTools = _sessionPolicy.RoutingCatalog.RecoveryAwareTools,
                    ...
                    isExplicitRoutingReady = _sessionPolicy.RoutingCatalog.IsExplicitRoutingReady,
