...
internal static class SystemNoticeFormatter {
    public static string Format(SystemNotice notice) {
        return notice.Kind switch {
            ...
            SystemNoticeKind.ConnectFailedAfterSidecarStart => "Couldn't connect after starting the background service: " + DetailOrUnknown(notice.Detail),
            SystemNoticeKind.ConnectFailed => "Connect failed: " + DetailOrUnknown(notice.Detail),
            SystemNoticeKind.ServiceSidecarUnavailable => "Background service is unavailable.",
