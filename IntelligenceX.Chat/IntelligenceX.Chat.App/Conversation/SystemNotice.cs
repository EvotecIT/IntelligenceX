...
internal static class SystemNoticeFormatter {
    public static string Format(SystemNotice notice) {
        return notice.Kind switch {
            ...
            SystemNoticeKind.ServiceStagingError => "Service staging error: " + DetailOrUnknown(notice.Detail),
            ...
            SystemNoticeKind.ServiceSidecarSourceFolderNotFound => "Service sidecar source folder not found.",
            SystemNoticeKind.ServiceSidecarStagingFailed => "Service sidecar staging failed.",
            SystemNoticeKind.ServiceSidecarNotFoundNextToApp => "Service sidecar not found next to app.",
            ...
            SystemNoticeKind.ServiceStartFailed => "Service start failed: " + DetailOrUnknown(notice.Detail),
            ...
            SystemNoticeKind.ConnectProbeFailed => "Connect probe failed: " + DetailOrUnknown(notice.Detail),
            SystemNoticeKind.ConnectFailedAfterSidecarStart => "Connect failed after sidecar start: " + DetailOrUnknown(notice.Detail),
            SystemNoticeKind.ConnectFailed => "Connect failed: " + DetailOrUnknown(notice.Detail),
            SystemNoticeKind.ServiceSidecarUnavailable => "Service sidecar unavailable.",
            SystemNoticeKind.HelloFailed => "Hello failed: " + DetailOrUnknown(notice.Detail),
            SystemNoticeKind.ListToolsFailed => "list_tools failed: " + DetailOrUnknown(notice.Detail),
