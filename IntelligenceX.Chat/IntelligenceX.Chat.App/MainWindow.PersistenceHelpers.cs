...
public sealed partial class MainWindow : Window {
    ...
    private string? EnsureStagedServiceDirectory(string serviceSourceDir) {
        ...
        if (!string.IsNullOrWhiteSpace(_stagedServiceDir) && Directory.Exists(_stagedServiceDir)) {
        ...
        try {
            ...
            var stagedDir = Path.Combine(runtimeRoot, Guid.NewGuid().ToString("N"));
            DirectoryCopy(serviceSourceDir, stagedDir);
