    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Presets =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase) {
            ...
            ["graphite"] = new Dictionary<string, string> {
                ["--ix-accent"] = "#9ca3af",
                ["--ix-accent-hover"] = "#cbd5e1",
                ["--ix-accent-gradient"] = "linear-gradient(135deg, #9ca3af, #64748b)",
                ["--ix-bg-primary"] = "#111827",
                ["--ix-bg-secondary"] = "#1a2438",
                ["--ix-bg-elevated"] = "#263245",
                ["--ix-text-secondary"] = "#c3d0e2",
                ["--ix-text-muted"] = "#8ea3bc",
                ["--ix-border-subtle"] = "rgba(94, 112, 136, 0.55)",
                ["--ix-input-border"] = "#61758f",
                ["--ix-menu-bg"] = "rgba(24, 34, 50, 0.98)",
                ["--ix-menu-border"] = "#61758f",
                ["--ix-bubble-assistant-bg"] = "rgba(39, 55, 79, 0.62)",
                ["--ix-bubble-assistant-border"] = "rgba(148, 163, 184, 0.34)",
                ["--ix-bubble-user-bg"] = "rgba(33, 46, 67, 0.66)",
                ["--ix-bubble-user-border"] = "rgba(148, 163, 184, 0.3)",
                ["--ix-status-ok"] = "#9ca3af",
                ["--ix-input-focus"] = "#9ca3af",
                ["--ix-user-avatar-bg"] = "#64748b",
                ["--ix-dropdown-bg"] = "#243247",
                ["--ix-select-item-hover"] = "rgba(156, 163, 175, 0.24)",
                ["--ix-send-btn-text"] = "#111827",
                ["--ix-send-btn-border"] = "rgba(156, 163, 175, 0.45)",
                ["--ix-send-btn-shadow"] = "0 8px 18px rgba(148, 163, 184, 0.24)",
                ["--ix-sidebar-bg"] = "linear-gradient(180deg, rgba(33, 45, 64, 0.85) 0%, rgba(17, 24, 39, 0.78) 100%)",
                ["--ix-sidebar-item-bg"] = "rgba(33, 46, 67, 0.58)",
                ["--ix-sidebar-item-hover"] = "rgba(156, 163, 175, 0.16)",
                ["--ix-sidebar-item-active"] = "rgba(156, 163, 175, 0.24)",
                ["--ix-sidebar-item-active-border"] = "rgba(156, 163, 175, 0.72)",
                ["--ix-scrollbar-thumb"] = "rgba(156, 163, 175, 0.42)",
                ["--ix-scrollbar-thumb-hover"] = "rgba(156, 163, 175, 0.62)"
            }
        };
