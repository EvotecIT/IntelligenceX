...
public sealed partial class MainWindow : Window {
    ...
    private string FormatActivityText(ChatStatusMessage status) {
        ...
        return status.Status switch {
            ...
            ChatStatusCodes.BackgroundWorkQueued => "Queued background follow-up work...",
            ChatStatusCodes.BackgroundWorkReady => "Background follow-up work is ready...",
            ChatStatusCodes.BackgroundWorkRunning => "Background follow-up work started...",
            ChatStatusCodes.BackgroundWorkCompleted => "Background follow-up work completed",
    ...
    private string BuildActivityTimelineLabel(ChatStatusMessage status, string activityText) {
        ...
        var label = normalizedStatus switch {
            ...
            ChatStatusCodes.BackgroundWorkQueued => "background queued",
            ChatStatusCodes.BackgroundWorkReady => "background ready",
            ChatStatusCodes.BackgroundWorkRunning => "background running",
            ChatStatusCodes.BackgroundWorkCompleted => "background completed",
