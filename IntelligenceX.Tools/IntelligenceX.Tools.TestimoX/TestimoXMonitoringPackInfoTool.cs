...
/// <summary>
/// Returns TestimoX monitoring artifact pack capabilities and usage guidance for model-driven tool planning.
/// </summary>
public sealed class TestimoXMonitoringPackInfoTool : TestimoXToolBase, ITool {
    private sealed record PackInfoRequest;

    private static readonly ToolDefinition DefinitionValue = new(
        "testimox_monitoring_pack_info",
        "Return TestimoX monitoring artifact pack capabilities, output contract, and recommended usage patterns. Call this first when planning history/report/snapshot inspection.",
        ToolSchema.Object().NoAdditionalProperties());

    /// <summary>
    /// Initializes a new instance of the <see cref="TestimoXMonitoringPackInfoTool"/> class.
    /// </summary>
    public TestimoXMonitoringPackInfoTool(TestimoXToolOptions options) : base(options) { }
    ...
    private Task<string> ExecuteAsync(ToolPipelineContext<PackInfoRequest> context, CancellationToken cancellationToken) {
        ...
        var root = ToolPackGuidance.Create(
            pack: "testimox_monitoring",
            engine: "ADPlayground.Monitoring",
            tools: ToolRegistryTestimoXMonitoringExtensions.GetRegisteredToolNames(Options),
            recommendedFlow: new[] {
            ...
            toolCatalog: ToolRegistryTestimoXMonitoringExtensions.GetRegisteredToolCatalog(Options),
        ...
        var summary = ToolMarkdown.SummaryText(
            title: "TestimoX Monitoring Pack",
            "Use this pack for persisted monitoring, report, and history artifacts.",
