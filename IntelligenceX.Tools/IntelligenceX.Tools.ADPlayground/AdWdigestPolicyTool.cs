...
public sealed class AdWdigestPolicyTool : ActiveDirectoryToolBase, ITool {
    ...
    private sealed record AdWdigestPolicyResult(
        string DomainName,
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AdWdigestPolicyTool"/> class.
    /// </summary>
    public AdWdigestPolicyTool(ActiveDirectoryToolOptions options) : base(options) { }
    ...
    protected override Task<string> InvokeCoreAsync(JsonObject? arguments, CancellationToken cancellationToken) {
        ...
        try {
            ...
            return Task.FromResult(ErrorFromException(ex, defaultMessage: "WDigest policy query failed.", invalidOperationErrorCode: "query_failed"));
        }
