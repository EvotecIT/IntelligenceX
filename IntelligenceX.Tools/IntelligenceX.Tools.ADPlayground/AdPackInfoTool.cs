    ...
    internal static ToolPackInfoModel BuildGuidance(ActiveDirectoryToolOptions options) {
        return ToolPackGuidance.Create(
            ...
            recommendedFlow: new[] {
                ...
                "Use ad_monitoring_probe_catalog + ad_monitoring_probe_run for runtime monitoring probes, including AD FS, Entra Connect, SQL Server, and Windows Backup. AD FS, Entra Connect, and Windows Backup require explicit hosts; SQL Server accepts explicit targets or MSSQLSvc SPN discovery. For probe_kind=directory, inspect the catalog's directory_probe_subkinds and follow those preferred follow-up tools before generic host pivots. For the established AD probe kinds, inspect follow_up_profiles and result_signal_profiles before choosing generic host pivots.",
            ...
            capabilities: new[] {
                ...
                ToolPackGuidance.Capability(
                    ...
                    summary: "Run ADPlayground.Monitoring probes through one generic catalog/runner pair, including AD FS, Entra Connect, SQL Server, and Windows Backup, with probe-appropriate target discovery and follow-through metadata.",
