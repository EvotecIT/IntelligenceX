    ...
    protected override Task<string> InvokeCoreAsync(JsonObject? arguments, CancellationToken cancellationToken) {
        ...
        var root = ToolPackGuidance.Create(
            ...
            recommendedFlow: new[] {
                ...
                "Use ad_service_account_usage/ad_never_logged_in_accounts/ad_stale_accounts for account hygiene and dormant-identity exposure checks.",
            ...
            flowSteps: new[] {
                ...
                ToolPackGuidance.FlowStep(
                    ...
                    suggestedTools: new[] { "ad_duplicate_accounts", "ad_ou_protection", "ad_registration_posture", "ad_laps_coverage", "ad_service_account_usage", "ad_never_logged_in_accounts", "ad_stale_accounts" }),
                ToolPackGuidance.FlowStep(
            ...
            capabilities: new[] {
                ...
                ToolPackGuidance.Capability(
                    ...
                    primaryTools: new[] { "ad_duplicate_accounts", "ad_ou_protection", "ad_registration_posture", "ad_laps_coverage", "ad_service_account_usage", "ad_never_logged_in_accounts", "ad_stale_accounts" }),
                ToolPackGuidance.Capability(
