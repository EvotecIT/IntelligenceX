    ...
    private Task<string> ExecuteAsync(ToolPipelineContext<PackInfoRequest> context, CancellationToken cancellationToken) {
        ...
        var root = ToolPackGuidance.Create(
            ...
            recommendedFlow: new[] {
                ...
                "Use system_tls_posture/system_winrm_posture/system_powershell_logging_posture/system_uac_posture/system_interactive_logon_posture/system_network_client_posture/system_rdp_posture/system_smb_posture/system_boot_configuration/system_bios_summary for host-hardening and firmware posture checks.",
                "Use system_security_options/system_tls_posture/system_winrm_posture/system_powershell_logging_posture/system_uac_posture/system_interactive_logon_posture/system_network_client_posture when you need a registry-backed Windows policy snapshot.",
            ...
            flowSteps: new[] {
                ...
                ToolPackGuidance.FlowStep(
                    ...
                    suggestedTools: new[] { "system_process_list", "system_ports_list", "system_network_adapters", "system_firewall_rules", "system_firewall_profiles", "system_security_options", "system_tls_posture", "system_winrm_posture", "system_powershell_logging_posture", "system_uac_posture", "system_interactive_logon_posture", "system_network_client_posture", "system_rdp_posture", "system_smb_posture", "system_time_sync", "system_bitlocker_status" }),
                ToolPackGuidance.FlowStep(
            ...
            entityHandoffs: new[] {
                ToolPackGuidance.EntityHandoff(
                    ...
                    targetTools: new[] { "system_info", "system_process_list", "system_service_list", "system_ports_list", "system_security_options", "system_tls_posture", "system_winrm_posture", "system_powershell_logging_posture", "system_uac_posture", "system_interactive_logon_posture", "system_network_client_posture", "system_time_sync", "system_updates_installed", "system_disks_list", "system_logical_disks_list" },
                    fieldMappings: new[] {
