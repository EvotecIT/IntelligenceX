...
- [x] Extend `eventlog_live_query` and `eventlog_evtx_query` with structured advanced EventViewerX filters (`keywords`, `level`, `user_id`, `event_record_id`, `named_data_filter`, `named_data_exclude_filter`) and safe validation/caps.
